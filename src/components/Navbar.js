            ...
            <div className="navbar-start has-text-centered">
              ...
              <div className="navbar-item has-dropdown is-hoverable dropDownItem">
                ...
                >
                  ...
                  <Link to="/atc-partners" className="navbar-item">
                    ATC Partners
                  </Link>
                  <Link to="/energy-lab-partners" className="navbar-item">
                    Energy Lab Partners
                  </Link>
                </div>
              </div>
              ...
              <div className="navbar-item has-dropdown is-hoverable dropDownItem">
                ...
                <div
                  ...
                  onKeyPress={() => this.toggleHamburger()}
                >
                  <Link to="/sweat-testing" className="navbar-item">
                    Sweat Testing
                  </Link>
                  <Link to="vo2-rmr-testing" className="navbar-item">
                    VO2 & RMR Testing
                  </Link>
